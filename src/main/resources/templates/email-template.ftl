...
<table style="background:#fffff; width: 600px; margin: 20px auto; font-family: Verdana, sans-serif;">
    <tr>
        ...
        <td>
            <img style="border-radius: 0%; width:100%; display: block; margin: 20px auto;" src="https://i.imgur.com/kAky3Cs.png" alt=""></a>
        </td>
        <td style="width: 10px;"></td>
    </tr>
    <tr>
 ...
 <tr>
      ...
      <tr>
        <td colspan="3">
                ...
                <a style="font-size: 15px; text-decoration: none; color: #fff;" href="https://milled.com/brazil-empiricus-cpl/acabaram-as-newsletters-0mx4ioTVyg4xnFse">Clique aqui para abri-la </a></span>
        </td>
      </tr>
